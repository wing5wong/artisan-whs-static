...
<?php if($page->leads_to): ?>
<h3 class="d-inline">Leads To:</h3> <?php $__currentLoopData = explode(",", $page->leads_to); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><a href="/courses/<?php echo e(trim($leads)); ?>/"><?php echo e(trim($leads)); ?></a> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  <br><br>
<?php endif; ?>
