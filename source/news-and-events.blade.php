        ...
        <div class="swiper-container w-100">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide p-5 d-flex align-items-center justify-content-center"
                    style="background: #fff; background-image: url({{$article->feature_image ? $article->feature_image["image"] : $article->image}}); background-size: cover; width: 100%; height: 350px;">
